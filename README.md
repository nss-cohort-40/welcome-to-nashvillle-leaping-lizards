...
2. This project relies on access to for different APIs. 
  ...
  You will need to register and obtain an app key and app id. only for __FOOD API__ and __Ticketmaster API__
